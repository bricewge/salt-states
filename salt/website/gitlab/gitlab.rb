...
external_url 'https://{{ salt['pillar.get']('website:gitlab:domain') }}'
...
gitlab_rails['omniauth_providers'] = [
  {
    "name" => "github",
    "app_id" => "efff33affca78cc70f51",
    "app_secret" => "bc2b04fff8f06b53ed37f7a9214f8a40715f285d",
...
# gitlab_rails['registry_host'] = "git.bricewge.fr"
...
registry_external_url 'https://{{ salt['pillar.get']('website:gitlab:domain') }}:4567'
